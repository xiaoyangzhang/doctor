...
import com.yhyt.health.model.vo.PatientTransferVo;
...
public interface DialogAppointmentTransferMapper {
    ...
    List<PatientTransferVo> getMyPatientTransfer(@Param("patientId") Long patientId,@Param("states") List<Byte> states);
}